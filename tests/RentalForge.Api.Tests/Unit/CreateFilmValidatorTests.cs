...
{
    private readonly CreateFilmValidator _sut = new();
    private readonly Fixture _fixture = new();

    public CreateFilmValidatorTests()
    {
        _fixture.Customize<CreateFilmRequest>(c => c
    ...
    {
        var request = _fixture.Create<CreateFilmRequest>();
    ...
    {
        var request = _fixture.Create<CreateFilmRequest>() with { Title = title! };
        var result = _sut.TestValidate(request);
    ...
    {
        var request = _fixture.Create<CreateFilmRequest>() with { Title = new string('A', 256) };
        var result = _sut.TestValidate(request);
        result.ShouldHaveValidationErrorFor(x => x.Title);
    }
    ...
    {
        var request = _fixture.Create<CreateFilmRequest>() with { Title = new string('A', 255) };
        var result = _sut.TestValidate(request);
    ...
    {
        var request = _fixture.Create<CreateFilmRequest>() with { Description = new string('A', 1001) };
        var result = _sut.TestValidate(request);
    ...
    {
        var request = _fixture.Create<CreateFilmRequest>() with { Description = new string('A', 1000) };
        var result = _sut.TestValidate(request);
    ...
    {
        var request = _fixture.Create<CreateFilmRequest>() with { Description = null };
        var result = _sut.TestValidate(request);
        result.ShouldNotHaveValidationErrorFor(x => x.Description);
    }
    ...
    {
        var request = _fixture.Create<CreateFilmRequest>() with { ReleaseYear = 1887 };
        var result = _sut.TestValidate(request);
    ...
    {
        var request = _fixture.Create<CreateFilmRequest>() with { ReleaseYear = DateTime.UtcNow.Year + 6 };
        var result = _sut.TestValidate(request);
        result.ShouldHaveValidationErrorFor(x => x.ReleaseYear);
    }
    ...
    {
        var request = _fixture.Create<CreateFilmRequest>() with { ReleaseYear = 1888 };
        var result = _sut.TestValidate(request);
    ...
    {
        var request = _fixture.Create<CreateFilmRequest>() with { ReleaseYear = DateTime.UtcNow.Year + 5 };
        var result = _sut.TestValidate(request);
        result.ShouldNotHaveValidationErrorFor(x => x.ReleaseYear);
    }
    ...
    {
        var request = _fixture.Create<CreateFilmRequest>() with { ReleaseYear = null };
        var result = _sut.TestValidate(request);
        result.ShouldNotHaveValidationErrorFor(x => x.ReleaseYear);
    }
    ...
    {
        var request = _fixture.Create<CreateFilmRequest>() with { LanguageId = languageId };
        var result = _sut.TestValidate(request);
    ...
    {
        var request = _fixture.Create<CreateFilmRequest>() with { OriginalLanguageId = originalLanguageId };
        var result = _sut.TestValidate(request);
    ...
    {
        var request = _fixture.Create<CreateFilmRequest>() with { OriginalLanguageId = null };
        var result = _sut.TestValidate(request);
    ...
    {
        var request = _fixture.Create<CreateFilmRequest>() with { RentalDuration = rentalDuration };
        var result = _sut.TestValidate(request);
    ...
    {
        var request = _fixture.Create<CreateFilmRequest>() with { RentalRate = (decimal)rentalRate };
        var result = _sut.TestValidate(request);
    ...
    {
        var request = _fixture.Create<CreateFilmRequest>() with { Length = length };
        var result = _sut.TestValidate(request);
    ...
    {
        var request = _fixture.Create<CreateFilmRequest>() with { Length = null };
        var result = _sut.TestValidate(request);
    ...
    {
        var request = _fixture.Create<CreateFilmRequest>() with { ReplacementCost = (decimal)replacementCost };
        var result = _sut.TestValidate(request);
    ...
    {
        var request = _fixture.Create<CreateFilmRequest>() with { Rating = (MpaaRating)99 };
        var result = _sut.TestValidate(request);
    ...
    {
        var request = _fixture.Create<CreateFilmRequest>() with { Rating = null };
        var result = _sut.TestValidate(request);
    ...
    {
        var request = _fixture.Create<CreateFilmRequest>() with { Rating = rating };
        var result = _sut.TestValidate(request);
        result.ShouldNotHaveValidationErrorFor(x => x.Rating);
    }
}
