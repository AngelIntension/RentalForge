...
public class UpdateCustomerValidatorTests
{
    ...
    {
        _fixture.Customize<UpdateCustomerRequest>(c => c
    ...
    {
        var request = _fixture.Create<UpdateCustomerRequest>() with { FirstName = firstName! };
        var result = _sut.TestValidate(request);
    ...
    {
        var request = _fixture.Create<UpdateCustomerRequest>() with { FirstName = new string('A', 46) };
        var result = _sut.TestValidate(request);
        result.ShouldHaveValidationErrorFor(x => x.FirstName);
    }
    ...
    {
        var request = _fixture.Create<UpdateCustomerRequest>() with { FirstName = new string('A', 45) };
        var result = _sut.TestValidate(request);
    ...
    {
        var request = _fixture.Create<UpdateCustomerRequest>() with { LastName = lastName! };
        var result = _sut.TestValidate(request);
    ...
    {
        var request = _fixture.Create<UpdateCustomerRequest>() with { LastName = new string('B', 46) };
        var result = _sut.TestValidate(request);
        result.ShouldHaveValidationErrorFor(x => x.LastName);
    }
    ...
    {
        var request = _fixture.Create<UpdateCustomerRequest>() with { LastName = new string('B', 45) };
        var result = _sut.TestValidate(request);
    ...
    {
        var request = _fixture.Create<UpdateCustomerRequest>() with { Email = "not-an-email" };
        var result = _sut.TestValidate(request);
    ...
    {
        var request = _fixture.Create<UpdateCustomerRequest>() with { Email = "user@example.com" };
        var result = _sut.TestValidate(request);
    ...
    {
        var request = _fixture.Create<UpdateCustomerRequest>() with { Email = null };
        var result = _sut.TestValidate(request);
        result.ShouldNotHaveValidationErrorFor(x => x.Email);
    }
    ...
    {
        var request = _fixture.Create<UpdateCustomerRequest>() with { Email = new string('a', 42) + "@test.com" }; // 51 chars
        var result = _sut.TestValidate(request);
        result.ShouldHaveValidationErrorFor(x => x.Email);
    }
    ...
    {
        var request = _fixture.Create<UpdateCustomerRequest>() with { StoreId = storeId };
        var result = _sut.TestValidate(request);
    ...
    {
        var request = _fixture.Create<UpdateCustomerRequest>() with { AddressId = addressId };
        var result = _sut.TestValidate(request);
